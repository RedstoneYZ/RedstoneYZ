...
export default class Matrix4 {
  ...
  static Perspective(w: number, h: number, n: number, f: number) {
    ...
    a[ 0] = 2*n/w; a[ 1] =     0; a[ 2] =           0; a[ 3] =  0;
    a[ 4] =     0; a[ 5] = 2*n/h; a[ 6] =           0; a[ 7] =  0;
    a[ 8] =     0; a[ 9] =     0; a[10] = (n+f)/(n-f); a[11] = -1;
    a[12] =     0; a[13] =     0; a[14] = 2*f*n/(n-f); a[15] =  0;
  ...
  static Orthographic(l: number, r: number, b: number, t: number, n: number, f: number) {
    ...
    a[ 0] =     2/(r-l); a[ 1] =           0; a[ 2] =           0; a[ 3] = 0;
    a[ 4] =           0; a[ 5] =     2/(t-b); a[ 6] =           0; a[ 7] = 0;
    a[ 8] =           0; a[ 9] =           0; a[10] =     2/(n-f); a[11] = 0;
    a[12] = (l+r)/(l-r); a[13] = (b+t)/(b-t); a[14] = (n+f)/(n-f); a[15] = 1;
